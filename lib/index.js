    ...
    visitor: {
      CallExpression(path) {
        ...
        if (callee.name === 'react' && firstArg &&
            !((firstArg.type === 'FunctionExpression' && firstArg.generator) ||
              (firstArg.type === 'CallExpression' && firstArg.callee.type === 'MemberExpression' && firstArg.callee.object.generator))) {
